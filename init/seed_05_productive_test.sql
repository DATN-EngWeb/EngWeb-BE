...
(3, 'A', 'Email', 'https://storage.googleapis.com/test-nens-english-app-vu/tests/3/part1/5e9c09a2-5f6c-4a17-8807-8dc00cbe9d8a.html', 100, '', '{"audio": null, "image": null}'::jsonb),
-- Speaking test configuration (format H - Description)
(4, 'H', 'Eating', 'https://storage.googleapis.com/test-nens-english-app-vu/tests/test_4/e9f8c724-8744-4382-92d8-e2cb465a0506.html', 0, '', '{"audio": null, "image": null}'::jsonb)
